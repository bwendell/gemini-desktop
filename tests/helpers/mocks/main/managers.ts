...
export function createMockWindowManager(
  overrides?: Partial<Omit<MockWindowManager, '_reset'>>
): MockWindowManager {
 ...
 * ```
 */
export function createMockUpdateManager(
  overrides?: Partial<Omit<MockUpdateManager, '_reset'>>
): MockUpdateManager {
 ...
 * ```
 */
export function createMockPrintManager(
  overrides?: Partial<Omit<MockPrintManager, '_reset'>>
): MockPrintManager {
...
export function createMockHotkeyManager(
  overrides?: Partial<Omit<MockHotkeyManager, '_reset'>>
): MockHotkeyManager {
...
export function createMockLlmManager(
  overrides?: Partial<Omit<MockLlmManager, '_reset'>>
): MockLlmManager {
