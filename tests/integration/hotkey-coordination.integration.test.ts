...
describe('HotkeyManager ↔ SettingsStore ↔ IpcManager Integration', () => {
    ...
    beforeEach(() => {
        ...
        mockStore = {
            ...
            set: vi.fn((key: string, value: any) => { storeData[key] = value; }),
            _data: storeData,
        };
    ...
    describe.each(['darwin', 'win32', 'linux'] as const)('on %s', (platform) => {
        ...
        describe('Rapid toggling without duplicates', () => {
            it('should handle rapid enable/disable without duplicate registrations', () => {
                ...
                const setCallsForAlwaysOnTop = (mockStore.set as any).mock.calls
                    .filter((call: any) => call[0] === 'hotkeyAlwaysOnTop');
                ...
                const registerCalls = (globalShortcut.register as any).mock.calls;
                const alwaysOnTopRegisters = registerCalls.filter((call: any) =>
                    call[0] === 'CommandOrControl+Shift+T'
                );
