            ...
            server = createServer((req, res) => {
                ...
                if (req.url === '/headers') {
                    res.writeHead(200, {
                        ...
                        'Content-Security-Policy': "frame-ancestors 'none'; default-src 'self' 'unsafe-inline' 'unsafe-eval' data: blob: https: http:; connect-src *", // Update CSP to verify logic works even with complex CPS
