...
describe('Navigation Security Integration', () => {
    ...
    describe.each(['darwin', 'win32', 'linux'] as const)('on %s', (platform) => {
        ...
        it('should allow navigation to internal files (file protocol)', () => {
            ...
            expect(mockLogger.log).toHaveBeenCalledWith(expect.stringContaining('Allowing navigation to local file'), expect.any(String));
        });
        ...
        it('should allow navigation to internal Gemini domains', () => {
            ...
            expect(mockEvent.preventDefault).not.toHaveBeenCalled();
            expect(mockLogger.log).toHaveBeenCalledWith(expect.stringContaining('Allowing navigation to internal URL'), expect.any(String));
        });
        ...
        it('should allow navigation to OAuth domains', () => {
            ...
            expect(mockEvent.preventDefault).not.toHaveBeenCalled();
            expect(mockLogger.log).toHaveBeenCalledWith(expect.stringContaining('Allowing navigation to OAuth URL'), expect.any(String));
        });
        ...
        it('should BLOCK navigation to external domains', () => {
            ...
            expect(mockLogger.warn).toHaveBeenCalledWith(expect.stringContaining('Blocked navigation to external URL'), expect.any(String));
        });
        ...
        it('should intercept window.open for OAuth links and create auth window', () => {
            ...
            expect(mockLogger.log).toHaveBeenCalledWith(expect.stringContaining('Intercepting OAuth popup'), expect.any(String));
        });
