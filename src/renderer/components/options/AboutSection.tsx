    ...
    <div className="about-section" data-testid="about-section">
      ...
      <div className="about-disclaimer" data-testid="about-disclaimer">
        <p className="about-disclaimer-text">
          This application is an <strong>unofficial</strong> open-source project. It is{' '}
          <strong>NOT</strong> affiliated with, endorsed by, maintained by, or associated with
          Google LLC or the Gemini team in any way.
        </p>
      </div>
