...
describe('UpdateToast', () => {
    ...
    describe('rendering states', () => {
        it('renders update available toast', () => {
            ...
            expect(screen.getByTestId('update-toast-message')).toHaveTextContent('Version 1.2.3 is downloading...');
        });
        ...
        it('renders update downloaded toast', () => {
            ...
            expect(screen.getByTestId('update-toast-message')).toHaveTextContent('Version 1.2.3 is ready to install.');
        });
        ...
        it('renders default error message when no errorMessage provided', () => {
            ...
            expect(screen.getByTestId('update-toast-message')).toHaveTextContent('An error occurred while updating.');
        });
