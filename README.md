...
- **Manual update fallback UX** — improve the update flow by adding clearer download fallback behavior for edge-case updater failures. ([#174](https://github.com/bwendell/gemini-desktop/pull/174))
